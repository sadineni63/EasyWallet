...
public class UserRegistration {
	...
	private boolean createAccount() throws SQLException {
		...
		transactionStatement.setString(1, user.getUid());
		transactionStatement.setString(2, "consumer");
		transactionStatement.setInt(3, 0);
		transactionStatement.setString(4, "active");
		transactionStatement.setString(5, Math.random()+"");
		transactionStatement.setString(6, user.getEmail());
		if(transactionStatement.executeUpdate()==1)
		{
			connection.close();
				return true;
