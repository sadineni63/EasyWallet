			...
			<div class="xx">
				<div class="container" style="padding: 20px;">
					...
					<button type="button" class="btn btn-info btn-lg"
						data-toggle="modal" data-target="#login">Log In here</button>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
									...
									<form role="form" method="post" action="signIn.jsp">
										...
										<div class="form-group">
											<label for="psw"><span
												...
												type="password" class="form-control" id="pwd1" name="pwd1"
												placeholder="Enter password" required>
										</div>
										<button type="submit"
											class="btn btn-info btn-success btn-block">
								...
								<div class="modal-footer">
									...
									<p>
										Not a member? <a href="#" data-dismiss="modal"
											data-toggle="modal" data-target="#register">Sign Up</a>
									</p>
									</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<!-- Trigger the modal with a button -->
					<button type="button" class="btn btn-info btn-lg"
						data-toggle="modal" data-target="#register">Register Here</button>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<p>
										Already a member? <a href="#" data-dismiss="modal"
