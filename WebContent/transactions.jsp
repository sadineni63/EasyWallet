	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				<li><a style="color: blue; font-size: 18px" href="profile.html">Profile</a></li>
					...
					<div class="panel-heading">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab1" data-toggle="tab">All
									Transactions</a></li>
							<li><a href="#tab2" data-toggle="tab">Add Transactions</a></li>
											...
											<table id="example"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" rowspan="1" colspan="1"
															style="width: 20%">Credit Amount</th>
														<th class="sorting" tabindex="0" rowspan="1" colspan="1"
